    ...
    <div class="content">
      ...
      <ul>
        ...
        <ul>
          ...
          <li>スポンサーお申込みフォームで入力されたメールアドレス</li>
        </ul>
        <li>名前</li>
        <ul>
          <li>スポンサーお申込みフォームで入力されたご担当者名</li>
        </ul>
      </ul>
      ...
      <p class="readable">
        当カンファレンスは、ユーザーから収集した個人情報は、当カンファレンスの開催月の2018年11月30日まで利用するものとします。その利用期限が過ぎましたら、速やかに個人情報を完全に削除します。
      </p>
      ...
      <p class="readable">
        当カンファレンスは、収集した個人情報を個人情報保護法に基づき第三者に対して開示又は提供しないものとします。ただし、以下に該当する場合は、この限りではありません。
      </p>
...
export default {
  ...
  head () {
    return {
      title: 'Vue Fes Japan 2018 のプライバシーポリシー',
    }
  },
}
</script>
